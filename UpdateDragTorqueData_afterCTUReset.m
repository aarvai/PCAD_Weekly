function UpdateDragTorqueData_afterCTUReset(tstart, tstop)
...
% but, in the case of a SSM event, after returning to OBC control.
% Set tstop a few days to a month later.
% Run only once - then resume normal ops with PCAD_Weekly.
